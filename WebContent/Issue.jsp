		...
		<div class="privacy">
			<div class="container">
				<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
					style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Issue
					Tickets</h3>
				<form name="chngpwd" method="post" onSubmit="return valid();">
					...
					<table border="1" width="100%">
						...
						<tr align="center">
							<td>1</td>
							<td width="100">#TKT-4</td>
							<td>Cancellation</td>
							<td width="300">Lorem ipsum dolor sit amet, consectetur
							...
							<td>Sed ut perspiciatis unde omnis iste natus error sit
								...
								voluptas nulla pariatur</td>
							<td width="100">2017-05-14 03:33:33</td>
							<td width="100">2017-05-14 05:20:40</td>
						</tr>
					</table>
