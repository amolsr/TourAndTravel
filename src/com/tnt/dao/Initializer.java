...
public class Initializer implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			String Enquiry = "CREATE TABLE Enquiry (id SERIAL NOT NULL PRIMARY KEY,FullName varchar(100) DEFAULT NULL,EmailId varchar(100) DEFAULT NULL,MobileNumber char(10) DEFAULT NULL,Subject varchar(100) DEFAULT NULL,Description TEXT DEFAULT NULL,PostingDate timestamp NULL DEFAULT CURRENT_TIMESTAMP,Status int(1) DEFAULT NULL) ;";
			String Issue = "CREATE TABLE Issues (id SERIAL NOT NULL PRIMARY KEY,UserEmail varchar(100) DEFAULT NULL,Issue varchar(100) DEFAULT NULL,Description TEXT DEFAULT NULL,PostingDate timestamp NULL DEFAULT CURRENT_TIMESTAMP,AdminRemark TEXT DEFAULT NULL,AdminremarkDate timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP) ;";
